...
internal fun KtFirSymbol<FirStatusOwner>.getModality(
...
internal fun <F : FirStatusOwner<F>> KtFirSymbol<F>.getVisibility(phase: FirResolvePhase = FirResolvePhase.STATUS): Visibility =
