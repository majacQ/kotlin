...
import org.jetbrains.kotlin.fir.analysis.checkers.declaration.FirStatusOwnerChecker
...
object DummyNameChecker : FirStatusOwnerChecker() {
    override fun check(declaration: FirStatusOwner, context: CheckerContext, reporter: DiagnosticReporter) {
